...
class ShanghaiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val iv = findViewById<ImageView>(R.id.ivCity)
        Glide.with(this).load(photo).into(iv)

        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.title = if (city.isNotBlank()) city else "Shanghai"
    }
